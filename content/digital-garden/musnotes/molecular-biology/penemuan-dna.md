---
title: "DNA: Dari Nuklein hingga Heliks Ganda"
date: 2026-06-09T20:10:00+07:00
draft: false
aliases:
  - /digital-garden/musnotes/molucular-biology/penemuan-dna/
math: false
type: "garden-note"
summary: "Catatan tentang sejarah penemuan DNA, eksperimen penting yang membuktikan DNA sebagai materi genetik, serta struktur dasar DNA sebagai heliks ganda."
categories: ["Biology"]
tags: ["dna"]
---
...
<div class="mus-flow-tree">
  <div class="mus-flow-root">
    <span class="mus-flow-node">Nukleotida</span>
    <span class="mus-flow-note">Unit dasar pembentuk rantai DNA</span>
  </div>
  <div class="mus-flow-branches">
    <div class="mus-flow-branch">
      <span class="mus-flow-label">Komponen 1</span>
      <span class="mus-flow-node">Gula deoksiribosa</span>
    </div>
    <div class="mus-flow-branch">
      <span class="mus-flow-label">Komponen 2</span>
      <span class="mus-flow-node">Gugus fosfat</span>
    </div>
    <div class="mus-flow-branch">
      <span class="mus-flow-label">Komponen 3</span>
      <span class="mus-flow-node">Basa nitrogen</span>
      <span class="mus-flow-note">Adenin, Timin, Guanin, Sitosin</span>
    </div>
  </div>
</div>
{{< /rawhtml >}}
...
<div class="mus-flow-tree">
  <div class="mus-flow-root">
    <span class="mus-flow-node">Basa nitrogen DNA</span>
  </div>
  <div class="mus-flow-branches">
    <div class="mus-flow-branch">
      <span class="mus-flow-label">Purin</span>
      <span class="mus-flow-node">Adenin (A)</span>
      <span class="mus-flow-note">Berpasangan dengan T • 2 ikatan hidrogen</span>
    </div>
    <div class="mus-flow-branch">
      <span class="mus-flow-label">Pirimidin</span>
      <span class="mus-flow-node">Timin (T)</span>
      <span class="mus-flow-note">Berpasangan dengan A • 2 ikatan hidrogen</span>
    </div>
    <div class="mus-flow-branch">
      <span class="mus-flow-label">Purin</span>
      <span class="mus-flow-node">Guanin (G)</span>
      <span class="mus-flow-note">Berpasangan dengan C • 3 ikatan hidrogen</span>
    </div>
    <div class="mus-flow-branch">
      <span class="mus-flow-label">Pirimidin</span>
      <span class="mus-flow-node">Sitosin (C)</span>
      <span class="mus-flow-note">Berpasangan dengan G • 3 ikatan hidrogen</span>
    </div>
  </div>
</div>
{{< /rawhtml >}}
...
<div class="table-wrapper">
  <table>
    ...
    <tbody>
      <tr>
        <td>1869</td>
        <td>Friedrich Miescher</td>
        <td>Mengisolasi zat kaya fosfat dari inti sel darah putih dan menamainya <em>nuclein</em> (nuklein), yang kemudian diketahui sebagai bagian dari kelompok asam nukleat.</td>
      </tr>
      <tr>
        <td>1928</td>
        <td>Frederick Griffith</td>
        <td>Menemukan transformasi bakteri pada <em>Streptococcus pneumoniae</em>, yaitu perubahan sifat bakteri karena adanya materi kimia dari sel lain.</td>
      </tr>
      <tr>
        <td>1944</td>
        <td>Oswald Avery, Colin MacLeod, dan Maclyn McCarty</td>
        <td>Menunjukkan bahwa DNA adalah agen transformasi, bukan protein atau RNA.</td>
      </tr>
      <tr>
        <td>1950</td>
        <td>Erwin Chargaff</td>
        <td>Menemukan pola jumlah basa nitrogen: A ≈ T dan G ≈ C, yang kemudian menjadi petunjuk penting bagi model pasangan basa.</td>
      </tr>
      <tr>
        <td>1951–1952</td>
        <td>Rosalind Franklin dan Maurice Wilkins</td>
        <td>Menghasilkan data difraksi sinar-X yang memberi petunjuk bahwa DNA memiliki struktur heliks.</td>
      </tr>
      <tr>
        <td>1952</td>
        <td>Alfred Hershey dan Martha Chase</td>
        <td>Menguatkan bukti bahwa DNA, bukan protein, adalah materi genetik yang masuk ke dalam sel bakteri saat infeksi bakteriofag.</td>
      </tr>
      <tr>
        <td>1953</td>
        <td>James Watson dan Francis Crick</td>
        <td>Mengusulkan model struktur DNA sebagai heliks ganda dengan pasangan basa komplementer.</td>
      </tr>
    </tbody>
  </table>
</div>
...
1. **Strain S hidup** menyebabkan tikus mati.
2. **Strain R hidup** tidak menyebabkan tikus mati.
3. **Strain S yang sudah dimatikan dengan panas** tidak menyebabkan tikus mati.
4. **Campuran strain S mati karena panas dan strain R hidup** menyebabkan tikus mati.
...
<img src="/images/dna-double-helix.webp" alt="Visualisasi heliks ganda DNA yang menunjukkan tulang punggung gula-fosfat, pasangan basa nitrogen, ikatan hidrogen, serta major dan minor groove." loading="lazy">
...
* OpenStax. (2018). *Biology 2e, Chapter 14.1: Historical Basis of Modern Understanding*. [OpenStax](https://openstax.org/books/biology-2e/pages/14-1-historical-basis-of-modern-understanding)

* OpenStax. (2018). *Biology 2e, Chapter 14.2: DNA Structure and Sequencing*. [OpenStax](https://openstax.org/books/biology-2e/pages/14-2-dna-structure-and-sequencing)

* OpenStax. (2018). *Biology 2e, Chapter 14 Summary*. [OpenStax](https://openstax.org/books/biology-2e/pages/14-chapter-summary)

* OpenStax. (2018). *Biology 2e, Chapter 15.1: The Genetic Code*. [OpenStax](https://openstax.org/books/biology-2e/pages/15-1-the-genetic-code)

* OpenStax. (2018). *Biology 2e, Chapter 15.2: Prokaryotic Transcription*. [OpenStax](https://openstax.org/books/biology-2e/pages/15-2-prokaryotic-transcription)

* OpenStax. (2018). *Biology 2e, Chapter 15.3: Eukaryotic Transcription*. [OpenStax](https://openstax.org/books/biology-2e/pages/15-3-eukaryotic-transcription)

* OpenStax. (2018). *Biology 2e, Chapter 15.4: RNA Processing in Eukaryotes*. [OpenStax](https://openstax.org/books/biology-2e/pages/15-4-rna-processing-in-eukaryotes)

* OpenStax. (2018). *Biology 2e, Chapter 15.5: Ribosomes and Protein Synthesis*. [OpenStax](https://openstax.org/books/biology-2e/pages/15-5-ribosomes-and-protein-synthesis)
