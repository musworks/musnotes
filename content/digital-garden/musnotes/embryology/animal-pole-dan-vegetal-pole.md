---
title: "Animal Pole dan Vegetal Pole"
date: 2026-06-20T21:50:00+07:00
draft: false
aliases:
  - /digital-garden/musnotes/animal-pole-dan-vegetal-pole.md
math: false
type: "garden-note"
...
<div class="flow-container">
  <div class="flow-wrapper flow-wrapper--spaced">
    <div class="flow-node node-sage">
      <span class="node-label"><strong>Animal pole</strong><br>Lebih sedikit yolk.</span>
    </div>
    <div class="flow-arrow arrow-sage"></div>
    <div class="flow-node node-sage">
      <span class="node-label"><strong>Pembelahan lebih cepat</strong><br>Menghasilkan sel lebih kecil.</span>
    </div>
    <div class="flow-arrow arrow-sage"></div>
    <div class="flow-node node-blue">
      <span class="node-label"><strong>Micromeres</strong><br>Blastomere berukuran kecil.</span>
    </div>
  </div>

  <div class="flow-wrapper flow-wrapper--spaced">
    <div class="flow-node node-orchid">
      <span class="node-label"><strong>Vegetal pole</strong><br>Lebih kaya yolk.</span>
    </div>
    <div class="flow-arrow arrow-orchid"></div>
    <div class="flow-node node-orchid">
      <span class="node-label"><strong>Pembelahan lebih lambat</strong><br>Terhambat oleh yolk.</span>
    </div>
    <div class="flow-arrow arrow-orchid"></div>
    <div class="flow-node node-blue">
      <span class="node-label"><strong>Macromeres</strong><br>Blastomere berukuran besar.</span>
    </div>
  </div>
</div>
{{< /rawhtml >}}
  ...
  <table>
    <thead>
      <tr>
        <th>Wilayah</th>
        <th>Ciri Umum</th>
        <th>Dampak pada Cleavage</th>
      </tr>
    </thead>
    <tbody>
      <tr>
        <td><code>Animal pole</code></td>
        <td>Lebih sedikit yolk, lebih aktif secara pembelahan.</td>
        <td>Pembelahan cenderung lebih cepat.</td>
      </tr>
      <tr>
        <td><code>Vegetal pole</code></td>
        <td>Lebih kaya yolk.</td>
        <td>Pembelahan cenderung lebih lambat atau terbatas.</td>
      </tr>
    </tbody>
  </table>
</div>
