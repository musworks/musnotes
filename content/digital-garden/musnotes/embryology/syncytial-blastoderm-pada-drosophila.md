---
title: "Syncytial Blastoderm pada Drosophila"
date: 2026-06-23T22:10:00+07:00
draft: false
math: false
type: "garden-note"
...
<div class="flow-container">
  <div class="flow-wrapper flow-wrapper--spaced">
    <div class="flow-node node-orchid">
      <span class="node-label"><strong>Centrolecithal egg</strong><br>Yolk berada di tengah.</span>
    </div>
    <div class="flow-arrow arrow-orchid"></div>
    <div class="flow-node node-orchid">
      <span class="node-label"><strong>Nuclear divisions</strong><br>Inti membelah berkali-kali.</span>
    </div>
    <div class="flow-arrow arrow-orchid"></div>
    <div class="flow-node node-blue">
      <span class="node-label"><strong>Nuclei migrate outward</strong><br>Inti bergerak ke permukaan.</span>
    </div>
    <div class="flow-arrow arrow-blue"></div>
    <div class="flow-node node-blue">
      <span class="node-label"><strong>Syncytial blastoderm</strong><br>Banyak inti dalam sitoplasma bersama.</span>
    </div>
  </div>
</div>
{{< /rawhtml >}}
