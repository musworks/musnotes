...
draft: false
aliases:
  - /digital-garden/musnotes/dari-blastodisc-ke-blastoderm-pada-telur-ayam/
  - /digital-garden/musnotes/embriology/dari-blastodisc-ke-blastoderm-pada-telur-ayam/
math: false
type: "garden-note"
...
<div class="flow-container">
  <div class="flow-wrapper flow-wrapper--spaced">
    <div class="flow-node node-sage">
      <span class="node-label"><strong>Blastodisc</strong><br>Area sitoplasma aktif di atas yolk.</span>
    </div>
    <div class="flow-arrow arrow-sage"></div>
    <div class="flow-node node-sage">
      <span class="node-label"><strong>Discoidal cleavage</strong><br>Pembelahan hanya terjadi pada area berbentuk disc.</span>
    </div>
    <div class="flow-arrow arrow-sage"></div>
    <div class="flow-node node-orchid">
      <span class="node-label"><strong>Blastomeres</strong><br>Sel-sel hasil pembelahan blastodisc.</span>
    </div>
    <div class="flow-arrow arrow-orchid"></div>
    <div class="flow-node node-blue">
      <span class="node-label"><strong>Massa blastomere berbentuk disc</strong><br>Analogous, but not identical, to morula.</span>
    </div>
    <div class="flow-arrow arrow-blue"></div>
    <div class="flow-node node-blue">
      <span class="node-label"><strong>Blastoderm</strong><br>Lapisan sel di atas yolk.</span>
    </div>
  </div>
</div>
{{< /rawhtml >}}
...
<div class="table-wrapper">
  <table>
    ...
    <tbody>
      <tr>
        <td><code>Blastodisc</code></td>
        <td>Area sitoplasma aktif yang mengalami cleavage.</td>
        <td>Di atas massa yolk.</td>
      </tr>
      <tr>
        <td><code>Blastoderm</code></td>
        <td>Lapisan sel hasil cleavage pada blastodisc.</td>
        <td>Di atas massa yolk.</td>
      </tr>
    </tbody>
  </table>
...
<div class="table-wrapper">
  <table>
    <thead>
      <tr>
        <th>Konteks</th>
        <th>Bentuk Massa Sel Awal</th>
        <th>Penyebab</th>
      </tr>
    </thead>
    <tbody>
      <tr>
        <td>Holoblastic cleavage</td>
        <td>Bola sel padat.</td>
        <td>Seluruh zigot ikut membelah.</td>
      </tr>
      <tr>
        <td>Discoidal meroblastic cleavage</td>
        <td>Cakram sel di atas yolk.</td>
        <td>Hanya blastodisc yang membelah.</td>
      </tr>
    </tbody>
  </table>
</div>
