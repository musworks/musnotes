---
title: "Tipe Telur Berdasarkan Distribusi Yolk"
date: 2026-05-19T00:00:00+07:00
draft: false
aliases:
  - /digital-garden/musnotes/tipe-telur-berdasarkan-distribusi-yolk/
  - /digital-garden/musnotes/embriology/tipe-telur-berdasarkan-distribusi-yolk/
math: false
type: "garden-note"
...
- tidak ada area besar yang “tidak terbelah”
...
```text
   🔵  ← animal pole
   🔵     sedikit yolk, aktif membelah

██████ ← vegetal pole
         lebih banyak yolk, lebih padat
```

Meski terdapat penumpukan *yolk* di bagian bawah, “pisau” pembelahan sel masih mampu menembus seluruh bagian telur.
...
```text
Animal pole
🔵 🔵 🔵 🔵  ← sel lebih kecil, pembelahan lebih cepat

████ ████   ← sel lebih besar, pembelahan lebih lambat
Vegetal pole
```
...
Akibatnya, sitoplasma aktif yang bisa membelah terdesak dan hanya tersisa sebagai area kecil di kutub animal. Area kecil ini disebut **blastodisc**.

```text
   🔵  ← sitoplasma aktif (blastodisc)

████████████ ← yolk sangat besar dan padat
████████████
████████████
```

Karena *yolk* terlalu besar dan padat, “pisau” pembelahan tidak mampu menembus seluruh bagian telur.

Pembelahan akhirnya hanya terjadi pada area kecil di atas *yolk*, yaitu pada blastodisc.
...
<div class="flow-container">
  <div class="flow-wrapper flow-wrapper--spaced">
    <div class="flow-node node-sage">
      <span class="node-label"><strong>Isolecithal</strong><br>Yolk sedikit dan merata.<br><code>Holoblastik</code></span>
    </div>
    <div class="flow-arrow arrow-sage"></div>
    <div class="flow-node node-sage">
      <span class="node-label"><strong>Mesolecithal</strong><br>Yolk sedang, lebih banyak di bawah.<br><code>Holoblastik unequal</code></span>
    </div>
    <div class="flow-arrow arrow-sage"></div>
    <div class="flow-node node-orchid">
      <span class="node-label"><strong>Telolecithal</strong><br>Yolk sangat banyak di satu sisi.<br><code>Meroblastik diskoidal</code></span>
    </div>
    <div class="flow-arrow arrow-orchid"></div>
    <div class="flow-node node-blue">
      <span class="node-label"><strong>Centrolecithal</strong><br>Yolk berada di tengah.<br><code>Meroblastik superfisial</code></span>
    </div>
  </div>
</div>
{{< /rawhtml >}}
...
- Sangat banyak di satu sisi → pembelahan hanya terjadi di blastodisc
...
> - **Iso** = equal → yolk merata  
> - **Meso** = medium → yolk sedang, agak berat di bawah  
> - **Telo** = end atau ujung → yolk menumpuk di satu sisi  
> - **Centro** = center → yolk di tengah  
