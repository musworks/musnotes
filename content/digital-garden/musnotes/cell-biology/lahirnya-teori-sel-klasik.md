---
title: "Lahirnya Teori Sel Klasik (1839)"
date: 2026-03-15T00:00:00+07:00
draft: false
aliases:
  - /digital-garden/musnotes/lahirnya-teori-sel-klasik/
math: false
type: "garden-note"
summary: "Kesimpulan fundamental dari Schleiden dan Schwann bahwa sel adalah unit struktural terkecil makhluk hidup."
categories: ["Biology", "Cell Biology"]
tags: ["theory", "Schleiden", "Schwann", "classical theory"]
---

### Matthias Schleiden & Theodor Schwann (1839)
Melalui pengamatan pada jaringan tumbuhan dan hewan, dua ilmuwan Jerman ini merumuskan salah satu fondasi paling mendasar dalam biologi modern: _classical cell theory_.

1. Setiap organisme terdiri dari satu atau banyak sel.
...
.converge-arrows { transform: rotate(90deg); margin: 10px 0; }
}
</style>

<div class="converge-diagram">
<div class="converge-left">
<div class="flow-node node-sage">
<span class="node-icon">🌱</span>
<span class="node-label">Jaringan Tumbuhan</span>
</div>
<div class="flow-node node-sage">
<span class="node-icon">🐾</span>
<span class="node-label">Jaringan Hewan</span>
</div>
</div>

<div class="converge-arrows">
<svg width="50" height="90" viewBox="0 0 50 90" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M 0 15 C 25 15, 25 45, 45 45" stroke="#a3b59c" stroke-width="3" fill="none"/>
<path d="M 0 75 C 25 75, 25 45, 45 45" stroke="#a3b59c" stroke-width="3" fill="none"/>
<polygon points="45,45 35,39 35,51" fill="#a3b59c"/>
</svg>
</div>

<div class="converge-right">
<div class="flow-node node-orchid">
<span class="node-icon">🔬</span>
<span class="node-label"> classical cell theory</span>
</div>
</div>
</div>
