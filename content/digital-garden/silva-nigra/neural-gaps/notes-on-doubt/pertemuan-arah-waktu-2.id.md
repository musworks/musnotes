---
title: "Simpul Waktu Bagian II: Dua Panah di Satu Cangkir Kopi"
date: 2026-06-01T00:00:00+07:00
draft: false
math: false
type: "garden-note"
summary: "Catatan tentang pertemuan dua orientasi waktu, konflik entropi lokal, dan kemungkinan waktu sebagai bentuk siklik."
...
<div class="flow-stack__focus">
  <div class="flow-node flow-node--alert">
    ...
    <span class="node-label"><strong>Anomali Kausal</strong></span>
  </div>
</div>
...
<div class="mus-flow-tree">
  <div class="mus-flow-root">
    <span class="mus-flow-node">Bentuk Waktu</span>
  </div>

  <div class="mus-flow-branches">
    <div class="mus-flow-branch">
      <span class="mus-flow-label">Model linear</span>
      <span class="mus-flow-node">Awal ke akhir</span>
      <span class="mus-flow-note">Panah waktu bergerak satu arah dalam pengalaman sehari-hari.</span>
    </div>

<div class="mus-flow-branch">
  <span class="mus-flow-label">Model siklik</span>
  <span class="mus-flow-node">Akhir bertemu awal</span>
  <span class="mus-flow-note">Waktu dibayangkan sebagai pola yang menutup atau kembali pada dirinya sendiri.</span>
</div>
...
<div class="mus-flow-tree">
  ...
  <div class="mus-flow-branches">
    <div class="mus-flow-branch">
      <span class="mus-flow-label">Kemungkinan matematis</span>
      <span class="mus-flow-node">Jalur kembali ke masa lalu</span>
      <span class="mus-flow-note">Beberapa solusi relativitas umum mengizinkan lintasan waktu tertutup.</span>
    </div>
<div class="mus-flow-branch">
  <span class="mus-flow-label">Masalah fisik</span>
  <span class="mus-flow-node">Paradoks kausal</span>
  <span class="mus-flow-note">Peristiwa dapat mengganggu kondisi yang membuat dirinya sendiri mungkin.</span>
</div>

<div class="mus-flow-branch">
  <span class="mus-flow-label">Dugaan Hawking</span>
  <span class="mus-flow-node">Chronology protection</span>
  <span class="mus-flow-note">Hukum fisika mungkin mencegah paradoks waktu muncul secara makroskopik.</span>
</div>
  </div>
</div>
{{< /rawhtml >}}
...
<div class="mus-flow-tree">
  ...
  <div class="mus-flow-branches">
    <div class="mus-flow-branch">
      <span class="mus-flow-label">Aeon sebelumnya</span>
      <span class="mus-flow-node">Masa depan sangat jauh</span>
      <span class="mus-flow-note">Alam semesta mendekati keadaan yang sangat renggang dan didominasi radiasi.</span>
    </div>
<div class="mus-flow-branch">
  <span class="mus-flow-label">Transformasi konformal</span>
  <span class="mus-flow-node">Geometri diubah skala</span>
  <span class="mus-flow-note">Akhir yang sangat jauh dapat dipasangkan dengan awal siklus berikutnya.</span>
</div>
<div class="mus-flow-branch">
  <span class="mus-flow-label">Aeon berikutnya</span>
  <span class="mus-flow-node">Big Bang baru</span>
  <span class="mus-flow-note">Bukan awal absolut, melainkan permulaan bab kosmik berikutnya.</span>
</div>
  </div>
</div>
{{< /rawhtml >}}
