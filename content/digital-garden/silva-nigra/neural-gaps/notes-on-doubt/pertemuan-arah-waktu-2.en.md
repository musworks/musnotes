---
title: "Time Knot Part II: Two Arrows in One Cup of Coffee"
date: 2026-06-01T00:00:00+07:00
draft: false
math: false
type: "garden-note"
summary: "A note on the meeting of two temporal orientations, local entropy conflict, and the possibility of time as a cyclic form."
categories: ["Philosophy", "Physics"]
tags: ["time", "entropy", "causality", "cosmology", "closed-timelike-curves", "conformal-cyclic-cosmology"]
cover:
...
[Part I](pertemuan_arah_waktu.en.md) stopped at the failure of the linear model.
...
<div class="flow-stack__focus">
  <div class="flow-node flow-node--alert">
    ...
    <span class="node-label"><strong>Causal Anomaly</strong></span>
  </div>
</div>
...
<div class="mus-flow-tree">
  <div class="mus-flow-root">
    <span class="mus-flow-node">Shape of Time</span>
  </div>

  <div class="mus-flow-branches">
    <div class="mus-flow-branch">
      <span class="mus-flow-label">Linear model</span>
      <span class="mus-flow-node">Beginning to end</span>
      <span class="mus-flow-note">The arrow of time moves in one direction in everyday experience.</span>
    </div>

<div class="mus-flow-branch">
  <span class="mus-flow-label">Cyclic model</span>
  <span class="mus-flow-node">End meets beginning</span>
  <span class="mus-flow-note">Time is imagined as a pattern that closes or returns to itself.</span>
</div>
...
<div class="mus-flow-tree">
  <div class="mus-flow-root">
    <span class="mus-flow-node">Closed Timelike Curves</span>
  </div>

  <div class="mus-flow-branches">
    <div class="mus-flow-branch">
      <span class="mus-flow-label">Mathematical possibility</span>
      <span class="mus-flow-node">A path back to the past</span>
      <span class="mus-flow-note">Some solutions of general relativity permit closed paths through time.</span>
    </div>
<div class="mus-flow-branch">
  <span class="mus-flow-label">Physical problem</span>
  <span class="mus-flow-node">Causal paradox</span>
  <span class="mus-flow-note">An event may disturb the conditions that make itself possible.</span>
</div>

<div class="mus-flow-branch">
  <span class="mus-flow-label">Hawking’s conjecture</span>
  <span class="mus-flow-node">Chronology protection</span>
  <span class="mus-flow-note">The laws of physics may prevent time paradoxes from appearing macroscopically.</span>
</div>
  </div>
</div>
{{< /rawhtml >}}
...
<div class="mus-flow-tree">
  <div class="mus-flow-root">
    <span class="mus-flow-node">Conformal Cyclic Cosmology</span>
  </div>

  <div class="mus-flow-branches">
    <div class="mus-flow-branch">
      <span class="mus-flow-label">Previous aeon</span>
      <span class="mus-flow-node">Extremely distant future</span>
      <span class="mus-flow-note">The universe approaches a highly diffuse state dominated by radiation.</span>
    </div>
<div class="mus-flow-branch">
  <span class="mus-flow-label">Conformal transformation</span>
  <span class="mus-flow-node">Geometry is rescaled</span>
  <span class="mus-flow-note">The extremely distant end can be matched with the beginning of the next cycle.</span>
</div>
<div class="mus-flow-branch">
  <span class="mus-flow-label">Next aeon</span>
  <span class="mus-flow-node">New Big Bang</span>
  <span class="mus-flow-note">Not an absolute beginning, but the opening of the next cosmic chapter.</span>
</div>
  </div>
</div>
{{< /rawhtml >}}
...
[1]: https://link.aps.org/doi/10.1103/PhysRevD.46.603?utm_source=chatgpt.com "Chronology protection conjecture | Phys. Rev. D - APS Journals"
