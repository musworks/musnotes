---
title: "Why Thinking Alone Is Not Enough: Notes and Reflections on Scientific Temper"
date: 2026-06-12T15:00:00+07:00
draft: false
math: false
type: "garden-note"
summary: "Notes and reflections on Prof. Iwan Pranoto's explanation of the difference between thinking and reasoning, and the importance of cultivating scientific temper."
categories: ["Philosophy", "Education", "Cognitive"]
tags: ["scientific temper", "video notes", "malaka"]
----
...
<div class="mus-glossary">
  <section class="mus-glossary__item">
    <div class="mus-glossary__head">
      <div class="mus-glossary__symbol">
        <span class="mus-glossary__label">Concept</span>
        <code>Thinking</code>
      </div>
      <p class="mus-glossary__read">Indonesian: Berpikir</p>
    </div>
    <div class="mus-glossary__body">
      <p class="mus-glossary__meaning">A broad cognitive activity that tends to be reactive and does not necessarily require a strict structure. Thinking can be subjective because it may still involve values, emotions, personal beliefs, and a person's disposition or character.</p>
      <p class="mus-glossary__example">
        <span class="mus-glossary__label">Example</span>
        <code>Daydreaming, considering life choices, or judging the priority of something based on certain beliefs and moral values.</code>
      </p>
    </div>
  </section>
  ...
  <section class="mus-glossary__item">
    <div class="mus-glossary__head">
      ...
      <p class="mus-glossary__read">Indonesian: Bernalar</p>
    </div>
    <div class="mus-glossary__body">
      <p class="mus-glossary__meaning">A special form of thinking that has a specific purpose, is arranged in a rigorous structure, and follows the rules of logic. Reasoning attempts to be neutral, objective, and not controlled by personal values or beliefs.</p>
      <p class="mus-glossary__example">
        <span class="mus-glossary__label">Example</span>
        <code>Proving the equality of areas in a mathematical figure, or refuting a prosecutor's accusation in court with evidence and arguments.</code>
      </p>
    </div>
  </section>
</div>
...
<div class="mus-flow-tree">
  <div class="mus-flow-root">
    <span class="mus-flow-node">Scientific Temper</span>
  </div>

  <div class="mus-flow-branches">
    <div class="mus-flow-branch">
      <span class="mus-flow-label">Curiosity</span>
      <span class="mus-flow-node">Curiosity does not belong to any particular community or group, such as "the West".</span>
      <span class="mus-flow-note">The drive to search for truth and new information.</span>
    </div>
    <div class="mus-flow-branch">
      <span class="mus-flow-label">Demanding Evidence</span>
      <span class="mus-flow-node">Questioning the validity of a claim.</span>
      <span class="mus-flow-note">Not accepting ideas without adequate grounds.</span>
    </div>
    <div class="mus-flow-branch">
      <span class="mus-flow-label">Intellectual Humility</span>
      <span class="mus-flow-node">Being willing to revise one's view after realizing that an old opinion was mistaken.</span>
      <span class="mus-flow-note">Being humble before evidence.</span>
    </div>
  </div>
</div>
{{< /rawhtml >}}
...
<div class="mus-glossary">
  <section class="mus-glossary__item">
    <div class="mus-glossary__head">
      <div class="mus-glossary__symbol">
        <span class="mus-glossary__label">Figure</span>
        <code>Tan Malaka</code>
      </div>
      <p class="mus-glossary__read">Purpose of Education</p>
    </div>
    <div class="mus-glossary__body">
      <p class="mus-glossary__meaning">Sharpening the intellect, refining the feelings, and strengthening determination.</p>
    </div>
  </section>
  ...
  <section class="mus-glossary__item">
    <div class="mus-glossary__head">
      <div class="mus-glossary__symbol">
        <span class="mus-glossary__label">Figure</span>
        <code>Ki Hadjar Dewantara</code>
      </div>
      <p class="mus-glossary__read">Tri Suci</p>
    </div>
    <div class="mus-glossary__body">
      <p class="mus-glossary__meaning"><strong>Cipta (Citta)</strong>, Rasa, and Karsa.</p>
      <p class="mus-glossary__example">
        <span class="mus-glossary__label">Note</span>
        <code>Etymologically related to the Sanskrit word 'Citta', meaning thought or mind. Connected to the concepts of sharpening the intellect (cognitive), refining inner sensitivity (affective), and strengthening will or determination (conative).</code>
      </p>
    </div>
  </section>
  ...
  <section class="mus-glossary__item">
    <div class="mus-glossary__head">
      <div class="mus-glossary__symbol">
        <span class="mus-glossary__label">Figure</span>
        <code>Stephen Covey</code>
      </div>
      <p class="mus-glossary__read">Whole-Person Model</p>
    </div>
    <div class="mus-glossary__body">
      <p class="mus-glossary__meaning">The human being is understood as a whole through the dimensions of body, mind, heart, and spirit. In the context of education, this idea can be read as an invitation to form people who are not only intelligent, but also sensitive, capable, and able to make meaningful contributions.</p>
    </div>
  </section>
</div>
